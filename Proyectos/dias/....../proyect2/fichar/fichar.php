...
?>	
					...
					<p>
						...
						<p>
					<input type="number" value="0.00" step="0.01" name="gastos" style="width : 130px; heigth : 1px" id=gastos>&euro;
						</p>
						<p>
					<label>Notas:</label>
					</p>
					<p>
					<textarea rows="10" cols="60" name="notas" style="width : 130px; heigth : 1px" id=notas ></textarea>
					</p>
				...
				<div align=right>
						...
						<button  type=type="submit" formaction=/mobil/close.php form=er >Cerrar Sesion</button>
				</div> 
				<!--
				<div align=left>
    	 ...
    	 <tr style="width:10%">
            <div id="cfr">
					...
					<p>
						<select style="width : 130px; heigth : 1px" name="obra1" id=obra1 required>
...
?>
					...
					<p>
						<select name=obra2 style="width : 130px; heigth : 1px">
						<?php  //ponemos como opcion predeterminada la ultima obra introducida
...
?>
						...
						<p>
						<select style="width : 130px; heigth : 1px" name=obra3>
											<?php  //ponemos como opcion predeterminada la ultima obra introducida
...
?>
						...
						<p>
  						...
  						<p>
						<select style="width : 130px; heigth : 1px" name=obra4>
										<?php  //ponemos como opcion predeterminada la ultima obra introducida
...
?>
					...
					<input type=submit align="left" class=a value=Grabar id=sub name=Grabar>
						...
						<form action="/mobil/close.php" accept-charset="UTF-8" name=er id=er> 
						</form>
			</div>        
          </tr>
        </tr>
