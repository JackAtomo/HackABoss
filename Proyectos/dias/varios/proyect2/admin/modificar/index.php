...
<body>
<p>
<a  href="/web3/admin/index.php?usr=admin">Volver</a>
<p>
...
<!--fecha -->
  ...
  <!-- h_fin_jornada-->
	...
	<!--nombre obra1-->
	<td><?php if($valores[10] != "00:00"){echo $valores[10];}else{echo "";}  ?> </td>
	<!--h_obra1 -->
	<td><?php if($valores[11] != "00:00"){echo $valores[11];}else{echo "";}  ?> </td>
	<!--cod_obra2 -->
	<td><?php if($valores[12] != "00:00"){echo $valores[12];}else{echo "";}  ?> </td>
	<!--nombre obra2 -->
	<td><?php if($valores[13] != "00:00"){echo $valores[13];}else{echo "";}  ?> </td>
	<!--h_obra2 -->
	<td><?php if($valores[14] != "00:00:00"){echo $valores[14];}else{echo "";}  ?> </td>
	<!--cod_obra3 -->
	<td><?php if($valores[15] != "00:00:00"){echo $valores[15];}else{echo "";}  ?> </td>
	<!--nombre obra3 -->
	<td><?php if($valores[16] != "00:00:00"){echo $valores[16];}else{echo "";}  ?> </td>
	<!--h_obra3-->
	...
	<!--h_obra4-->
	<td><?php echo $valores[20]; ?> </td>
	<!--gastos-->
	<td><?php echo $valores[21]; ?> </td>
	<!--tipo-->
	<td><?php echo $valores[23]; ?> </td>
	...
	echo '<a target=_blank href="datos.php?value='.$valores[0].'">Modificar</a>';
  ?>
